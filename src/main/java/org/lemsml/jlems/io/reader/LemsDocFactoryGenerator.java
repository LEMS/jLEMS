...
public class LemsDocFactoryGenerator {
	...
	public static void main(String[] argv) throws IOException {
		//THIS IS NOT WORKING YET 27/02/2013
		LemsDocFactoryGenerator lfg = new LemsDocFactoryGenerator();
		
		String txt = lfg.generateJava();
 		
		File path = new File("./target/generated-sources/src/org/lemsml/jlems/reader");
		path.mkdirs();
		...
		File f =new File(path.getAbsolutePath()+"/LemsDocFactory.java");
