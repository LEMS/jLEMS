...
import org.lemsml.jlems.io.ImportNameMapper;
import org.lemsml.jlems.type.AddableTo;
import org.lemsml.jlems.type.Attribute;
import org.lemsml.jlems.type.Attributed;
import org.lemsml.jlems.type.Component;
import org.lemsml.jlems.type.ComponentContainer;
import org.lemsml.jlems.type.ElementAdder;
import org.lemsml.jlems.type.LemsCollection;
import org.lemsml.jlems.type.MetaContainer;
import org.lemsml.jlems.type.MetaItem;
import org.lemsml.jlems.type.Namable;
import org.lemsml.jlems.type.Parameterized;
import org.lemsml.jlems.type.Parented;
...
public class ReflectionInstantiator implements Constructor {
    ...
    public boolean setAttributeField(Object target, String name, String arg, Parameterized ptzd) throws ContentError, FormatException {
       ...
       public boolean setField(Object ob, String sfin, Object argin, Parameterized ptzd) throws ContentError, FormatException {
        ...
        if (!ok) {
        	throw new ContentError("Can't set field " + sf + " in " + ob + " from value " + arg);
        }
