...
public class PointResponse {
	...
	public void supResolve(Behavior bhv, LemsCollection<StateVariable> stateVariables, HashMap<String, Valued> valHM, Parser parser) throws ContentError, ParseError {
