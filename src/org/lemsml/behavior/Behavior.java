...
import org.lemsml.type.InstanceProperty;
...
import org.lemsml.type.Property;
import org.lemsml.type.Requirement;
import org.lemsml.util.ContentError;
import org.lemsml.util.E;


@Mel(info="Contains the description of the dynamical behavior of the ComponentType. Can also contain instructions on other elements to create when a component of this type is created. "
+ "Note that Dynamics is used for this element in the NeuroML Component definitions. "
+ "LEMS will handle Dynamics elements in the same way as Behavior elements.")
public class Behavior  {
	...
	public LemsCollection <Show> shows = new LemsCollection<Show>();
	
	public LemsCollection <Record> records = new LemsCollection<Record>();
	...
	@Deprecated
	public void setComponentClass(ComponentType t) {
		r_type = t;
	}
   ...
   private void countExposure(Named exposure, HashMap<String, Integer> exposedHM) throws ContentError {
		 ...
		 for (DerivedVariable dv : derivedVariables) {
			 if (dv.hasExpression()) {
                 ...
                 if (!dv.hasCondition()) {
                     ...
                     DoubleEvaluable dev = dv.getEvaluable();
                     BooleanEvaluable be = dv.getEvaluableCondition();
                     DoubleEvaluable devIfFalse = dv.getEvaluableIfFalse();
	...
	public RunDisplay makeRunDisplay(Component cpt, StateRunnable sr) throws ContentError {
        ...
        //E.info("Created run display "+ret+" for cpt "+cpt);
		return ret;
	}
